  ...
  return (
    <Container fluid={true}>
      <Row>
        <Col>
          <div id="brands">
            <a href="https://www.binance.com/?ref=37243377" target="_blank">
              <img src={binance} alt="logo" />
            </a>
            <a href="https://www.bitmex.com/register/kiQKAa" target="_blank">
              <img src={bitmex} alt="logo" />
            </a>
            <a href="https://brave.com/trq647" target="_blank">
              <img src={brave} alt="logo" />
            </a>
            <a href="https://www.deribit.com/reg-7152.7312" target="_blank">
              <img src={deribit} alt="logo" />
            </a>
            <a href="https://www.icmarkets.com/?camp=23195" target="_blank">
              <img src={icmarkets} alt="logo" />
            </a>
            <a href="https://www.kucoin.com/?rcode=tJeRc4" target="_blank">
              <img src={kucoin} alt="logo" />
            </a>
            <a href="https://shop.ledger.com/?r=fb95c418f05d" target="_blank">
              <img src={ledger} alt="logo" />
            </a>
            <a href="https://maklerska.pl/ref/TRQPro/" target="_blank">
